...
const CONFIG = {
  ...
  SEMINARS: {
    ...
    marke_general: {
      ...
      /* 選ぶ前に「24時間」と見せると、急いでいない方が振込を選んでしまう。
         期限の長さは書かず、選んでいただいてからお伝えする（2026-09-02）。
         {T} を使えば期限の長さが入るが、いまは選択前には出していない。 */
      paymentChoice: {
        card: { label: 'クレジットカード', note: 'このままお支払いいただけます',
                fallback: 20 },
        bank: { label: '銀行振込',         note: 'お振込でのお支払いをご希望の方',
                fallback: 1440,
                // 選んだあとにお見せする案内
                afterNote: 'お振込後、アプリから「振込完了のご連絡」をいただければ、お席は確保されます' }
      },
      promoteFallback: 1440,   // 繰上げのご案内が届いてからの期限（分）
      title: 'マーケティングセミナー',
      shortTitle: 'マーケティングセミナー',
      schedule: '9/29(火)・10/29(木)・11/25(水) 全3回 11:00〜15:00',
      dates: ['2026-09-29', '2026-10-29', '2026-11-25'],
